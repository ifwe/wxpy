...
wx._Dialog.GetDialogBorder = GetDialogBorder
wx._Panel.GetDefaultBorder = GetDefaultPanelBorder
wx._Notebook.GetDefaultBorder = GetDefaultPanelBorder
wx._SplitterWindow.GetDefaultBorder = GetDefaultPanelBorder

wx.WindowClass.GetDefaultBorder = GetDefaultBorder
wx.WindowClass.SetDefaultSizerProps = SetDefaultSizerProps
wx.WindowClass.SetSizerProp = SetSizerProp
wx.WindowClass.SetSizerProps = SetSizerProps
wx.WindowClass.GetSizerProps = GetSizerProps
...
class SizedPanel(wx.PyPanel):
    ...
    def AddChild(self, child):
        ...
        item.Window.SetDefaultSizerProps()
...
class SizedDialog(wx.Dialog):
    ...
    def SetButtonSizer(self, sizer):
        ...
        no = self.FindWindowById(wx.ID_NO, self)
        if no and cancel:
